...
HIGH_FREQUENCY_THR =0.01  #0.002 #0.2#0.002#use constant HIGH_FREQUENCY_THR => 0.002; orig, mine_test=0.8
            ...
            for line in ifh:
                ...
                for word in words:
                    ...
                    if word in stats:
                        ...
                        stats[word]=1
        #ifh.close() 
    print ("The size of n_words: ", n_words)         
...
def main():
    ...
    input_files='/home/ira/PhD/corpus_de/wiki_de'
    input_files='/home/ira/PhD/corpus_de/german_test.dat'
  
    patterns_input_file='selected_sym_patts_de_all.dat' #"selected_patterns_py.txt"

    
    context_vocab_file="context_vocab_out_de_all.dat"#file mapping context strings to 
    context_pairs_output_file ="context_file_out_de_all.dat"
    dic_file_order='cws_dictionary_allpats_order_de_all.dat' # 
    word_vocabulary_output_file='word_vocab_all_de.dat'
    dic_file='cws_dictionary_allpats_all_de.dat'
    mat_file='all_pats_mat_all_de.npz'
