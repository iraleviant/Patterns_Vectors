...
def main():
    ...
    patterns_input_file='final_symm_patt_russian.txt' #"selected_patterns_py.txt"

    
    context_vocab_file="context_vocab_out_python_rus.txt"#file mapping context strings to 
    context_pairs_output_file ="context_file_out_python_rus.txt"
    dic_file='cws_dictionary_all_pats_python_rus.dat'
    dic_file_order='cws_dictionary_allpats_python_order_rus.dat'
    word_vocabulary_output_file='word_vocab_python_allpats_python_rus.dat'
    mat_file='all_pats_python_mat_rus.npz'
