...
HIGH_FREQUENCY_THR = 0.2#0.002#use constant HIGH_FREQUENCY_THR => 0.002; orig, mine_test=0.8
MIN_FREQ =3#200 #orig=100, mine_test=3
...
def main():
    ...
    patterns_input_file="selected_patterns_py.txt"
    
    context_vocab_file="context_vocab_out_python.txt"#file mapping context strings to 
    context_pairs_output_file ="context_file_out_python.txt"
    dic_file='cws_dictionary_all_pats_python.dat'
    dic_file_order='cws_dictionary_allpats_python_order.dat'
    word_vocabulary_output_file='word_vocab_python_allpats_python.dat'
    mat_file='all_pats_python_mat.npz'
