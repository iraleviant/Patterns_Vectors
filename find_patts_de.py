...
def main():
    ...
    files='/home/ira/PhD/corpus_de/wiki_de'
    infile='/home/ira/PhD/corpus_de/wiki_de'
    
    #files='/home/ira/PhD/corpus_de/german_test.dat'
    #infile='/home/ira/PhD/corpus_de/german_test.dat'
    
    
    patts_candidates_file="patts_candidates_de.dat"
    selected_patts_file="selected_patts_de.dat "
    final_outfile_patts="final_sym_merged_patt_de.dat"  # Output file for selected SPs.
    ...
    m_thr = 0.02   # Threshold of M measure for selecting SPs, The only real important parameter is m_thr
    max_pattern_length = 5 ##7   # Maximum pattern length to consider.
    min_num_of_edges_per_pattern = 100#3   # Minimum of edge types for a pattern to be considered a candidate. (5000)
