...
def main():
    ...
    selected_sym_pats_file="selected_sym_patts_russian.txt"  # Output file for selected SPs.
    pattern_candidates_file="patterns_candidates_russian.txt"
    final_symmetric_patterns_file= "final_symm_patt_russian.txt"
