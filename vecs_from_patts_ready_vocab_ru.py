...
def main():
    ...
    patterns_input_file='final_symm_patt_russian1_ant.txt' #"selected_patterns_py.txt"

    
    context_vocab_file="context_vocab_out_rus1_ant.txt"#file mapping context strings to 
    context_pairs_output_file ="context_file_out_rus1_ant.txt"
    dic_file_order='cws_dictionary_allpats_order_rus1.dat' # 
    word_vocabulary_output_file='word_vocab_python_allpats__rus1_ant.dat'
    mat_file='all_pats_python_mat_rus1_ant.npz'
