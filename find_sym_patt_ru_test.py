...
def main():
    ...
    infile="/home/ira/Google_Drive/IraTechnion/PhD/corpus_ru/russian_test"  # 
    ...
    min_num_of_edges_per_pattern = 1#3   # Minimum of edge types for a pattern to be considered a candidate. (5000)
    ...
    selected_sym_pats_file="selected_sym_patts_rus.txt"  # Output file for selected SPs.
    pattern_candidates_file="patterns_candidates_rus.txt"
    final_symmetric_patterns_file= "final_symm_patt_russ.txt"
    ...
    write_vocab(pattern_candidates, pattern_candidates_file)
    ...
    write_sps(selected_sym_pats_file, selected_patterns)
    ...
    print ("Writing selected patterns to ",final_symmetric_patterns_file )
    write_sps(final_symmetric_patterns_file, selected_patterns)
